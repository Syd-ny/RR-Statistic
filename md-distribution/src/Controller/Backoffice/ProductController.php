...
class ProductController extends AbstractController
{
    ...
    public function processForm(Request $request, EntityManagerInterface $entityManager, Product $product): Response
    {
    ...
    {
        $product = new Product();
        return $this->processForm($request, $entityManager, $product);
    }
